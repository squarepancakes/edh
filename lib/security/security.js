...
function generateSHA256withRSAHeader(url, params, method, strContentType, appId, keyCertContent, keyCertPassphrase, realm) {
  ...
  //edh.api.gov.sg -> rfh.e.api.gov.sg
  ...
  var strApexHeader = "PKI_SIGN realm=\"" + realm + // Defaults to 1st part of incoming request hostname
    "\",timestamp=\"" + timestamp +
    "\",nonce=\"" + nonceValue +
    "\",app_id=\"" + appId +
    "\",signature_method=\"RS256\"" +
  ...
  // var strApexHeader = "apex realm=\"" + realm + // Defaults to 1st part of incoming request hostname
